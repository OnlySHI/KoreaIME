...
namespace HANGULIME
{
    ...
    vector<unsigned short> initials =
    {
    ...
    list<unsigned short> compose(list<unsigned short> source)
    {
        ...
        list<unsigned short>::iterator ittotal = source.begin();
        ittotal++;
        for (; ittotal != source.end(); ittotal++)
        {
            // Check to see if the character is Hangul Compatibility Jamo
            unsigned short unicode = (*ittotal);
